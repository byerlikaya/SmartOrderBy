...
public class OrderByEnumerableTest
{
    private readonly List<Publisher> _publisherList = DataInitializer.FillMockDataList();

    public OrderByEnumerableTest()
    {
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Ascending_By_Id()
    {
        ...
        //Act
        var result = _publisherList.OrderBy(request.OrderBy);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Ascending_By_Book_Id()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderBy(x => x.Books.FirstOrDefault()!.Id);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Descending_By_Book_Id()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderByDescending(x => x.Books.FirstOrDefault()!.Id);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Ascending_By_Author_Age()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderBy(x => x.Books.FirstOrDefault()!.Author.Age);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Descending_By_Author_Age()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderByDescending(x => x.Books.FirstOrDefault()!.Author.Age);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Ascending_By_Country_Name()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderBy(x => x.Books.FirstOrDefault()!.Author.Country.Name);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Descending_By_Country_Name()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderByDescending(x => x.Books.FirstOrDefault()!.Author.Country.Name);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Ascending_By_Language_Id()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderBy(x => x.MainAuthor.Languages.FirstOrDefault()!.Id);
    ...
    public void SmartOrderBy_Should_Return_Results_Order_By_Descending_By_Language_Id()
    {
        ...
        //Act
        var smartResult = _publisherList.OrderBy(request.OrderBy);
        var result = _publisherList.OrderByDescending(x => x.MainAuthor.Languages.FirstOrDefault()!.Id);
