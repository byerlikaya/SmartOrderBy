...
namespace Sample.Common
{
    public static class DataInitializer
    {
        ...
        private static readonly List<(int publisherId, int index, string bookName, string authorName, int publishedYear)> BookAndAuthorNames = new()
        {
        ...
        public static IQueryable<Publisher> FillMockData()
        {
            ...
            for (var i = 1; i <= 5; i++)
            {
                ...
                Publisher publisher = new()
                {
                    ...
                    {
                        Id = index,
                        Name = publisherBooks.FirstOrDefault().authorName,
                        Age = index,
